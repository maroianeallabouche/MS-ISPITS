            ...
            <div class="col-md-12">
                ...
                ?>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <b> PPR : <?php echo  $row2['num_matricule'];  ?></b>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <b> Grade et class : <?php echo  $row2['grade'];  ?></b>
                        </div>
                        <div class="col-md-3">
