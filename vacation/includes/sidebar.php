                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="ajouter_rib_p.php">Les profs</a>
                                    <a class="nav-link" href="ajouter_rib_a.php">Les Administrateurs</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayoutsa" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="affichage_rib_2.php">modifier RIB</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayoutsaz" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="supp_memoire.php">Supp. memoire</a>
                            ...
                            <div class="collapse" id="collapseLayoutsazr" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="affichage_frais_dep.php">frais de deplacement</a>
                                    <a class="nav-link" href="affiche_frais_tout.php">afficher les frais</a>
                                    <a class="nav-link" href="supp_frais.php">Supprimer les frais</a>
