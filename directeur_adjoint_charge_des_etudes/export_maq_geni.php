...
<div class="container-fluid px-4">
    <h1 class="mt-4">Affichage Notes modules et element des étudiants </h1>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="export_maq_geni_2.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="option" class="option" id="option" required>
                                    ...
                                    $sql = "SELECT options.nom_op,options.id_op FROM  options ";
