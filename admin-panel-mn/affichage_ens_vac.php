            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT *,filiere.nom_fil,options.nom_op FROM profs , filiere , options WHERE profs.id_f =filiere.id_f AND profs.id_op = options.id_op
                            and type_prof='ENSEIGNANTS VACATAIRES'
                             ORDER BY id_p ";
