    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="affichage_note_el_2.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="element" class="element" id="element" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <input required type="submit" name="recherche_el" value="Recherche" class="btn btn-primary" id="submit">
                        </div>
                    </form>
                </div>
            </div>
