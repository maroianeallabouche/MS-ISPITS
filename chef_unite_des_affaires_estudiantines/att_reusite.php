...
<div class="container-fluid px-4 mt-3 mb-4" id="invoice">
    ...
    ?>
        ...
        <div class="col-md-8 m-auto text-center pt-2">
            <h4><u> ATTESTATION DE REUSSITE </u></h4>
        </div><br> <br>
        ...
        <div class="row mt-3">
            <div class="col-md-11 m-auto">
                ...
                <div class="col-md-10 mx-5 mt-4  pt-2">
                    <b> A validé les Semestres &nbsp;&nbsp;
                     <input type="text" maxlength="3"  style="border: 0;font-weight:bold;" size="1" name="" id="">
                         et  &nbsp;&nbsp;
                    <input type="text" maxlength="3"  style="border: 0;font-weight:bold;" size="1" name="" id="">
                          au niveau de cet Institut l’Année Universitaire  <?php echo (date('Y') - 1) .'/'.date('Y');  ?> : </b>
                </div> <br>
                <ul>
