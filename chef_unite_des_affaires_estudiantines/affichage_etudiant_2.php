                ...
                <div class="card-body">
                    <div class="col-md-6 mb-3">
                        <form method="post" action="export.php">
                            <button type="submit" class="btn btn-success" name="export">Export <i class='fas fa-download'></i></button>
                        </form>
                    </div>
                        ...
                        <tbody id="etude">
                            ...
                            if (isset($_POST['recherche'])) {
                                ...
                                while ($row = mysqli_fetch_array($sql)) {
                                    ...
                                    echo "<td class='noExport'> <a href='etudiant_edit.php?id=$id_et' class='btn btn-primary'>Modifier</a>
                                        <a href='delete_etudiant.php?id=$id_et' class='btn btn-danger'>Supprimer</a> </td></tr>";
                                }
                            }
                            ?>
                        </tbody>
