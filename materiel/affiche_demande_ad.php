...
<div class="container-fluid px-4">
    ...
    <div class="row m-3">
        ...
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $_SESSION['id']=$id;
            $sql = "SELECT   materiel.designation , cmd_admin.qte , cmd_admin.date_cmd ,cmd_admin.id_mat
                    from cmd_admin , materiel
                    WHERE cmd_admin.id_mat=materiel.id_mat and cmd_admin.id=$id";
